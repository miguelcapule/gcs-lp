                                        ...
                                        <div class="card mt-4">
                                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                                <div
                                                    ...
                                                    <h6 class="text-white text-capitalize ps-3">Admin Lists</h6>
                                                </div>
                                            </div>
                                                    ...
                                                    <table class="table align-items-center mb-0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if (isset($_GET['look'])) {
                                                                ...
                                                                $get_user = mysqli_query($conn, "SELECT *, CONCAT(tbl_admins.lastname, ', ', tbl_admins.firstname) AS fullname 
                                                FROM tbl_admins");
                                                                while ($row = mysqli_fetch_array($get_user)) {
                                                                    ...
                                                                    <tr>
                                                                        <td><img class="img-fluid mr-4"
                                                                                src="data:image/jpeg;base64, <?php echo base64_encode($row['admin_image']); ?>"
                                                                        ...
                                                                        <td><a href="edit.admin.php<?php echo '?admin_id=' . $id; ?>"
                                                                            ...
                                                                            <button type="button" class="btn btn-danger"
                                                                                ...
                                                                                data-bs-target="#delete<?php echo $row['admin_id'] ?>"><i
                                                                    ...
                                                                    <div class="modal fade"
                                                                        id="delete<?php echo $row['admin_id'] ?>" tabindex="-1"
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    ...
                                                                                    <a type="button"
                                                                                        href="userData/user.del.admin.php?admin_id=<?php echo $row['admin_id'] ?>"
