                                    ...
                                    <div class="col-md-5 mb-3 mt-4">
                                        <form method="GET">
                                            <div class="input-group">
                                                <input type="search" class="form-control text-white" placeholder="Search for (Student no. or Name)" name="search">
                                                <div class="input-group-append">
                                                    <button type="submit" name="look" class="btn bg-navy mdi mdi-magnify" data-toggle="tooltip" data-placement="bottom" title="Search">
