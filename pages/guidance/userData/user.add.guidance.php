...
if (isset($_POST['submit']) && $_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($failed != 0) {
        ...
        $insertUser = mysqli_query($conn, "INSERT INTO tbl_guidance (guidance_image, firstname, lastname, activation_code, email, username, password) VALUES ('$image', '$firstname', '$lastname','', '$email', '$username', '$hashpwd')") or die(mysqli_error($conn));
