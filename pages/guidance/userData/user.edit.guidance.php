...
if (isset($_POST['submit']) && $_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $guidance_id = mysqli_real_escape_string($conn, $_POST['guidance_id']);
    ...
    if ($failed != 0) {
        ...
        $insertUser = mysqli_query($conn, "UPDATE tbl_guidance SET guidance_image = '$image', firstname = '$firstname', lastname = '$lastname', email = '$email', username = '$username', password = '$hashpwd' WHERE guidance_id = '$guidance_id'") or die(mysqli_error($conn));
