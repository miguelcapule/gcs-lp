                            ...
                            <div class="card mt-4">
                                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                        <h6 class="text-white text-capitalize ps-3">Students Evaluation</h6>
                                    </div>
                                </div>
                                        ...
                                        <table class="table align-items-center mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="add.eval.php<?php echo '?stud_id=' . $id; ?>"
                                                            type="button" class="btn btn-success mx-1"><i
                                                                class="fa fa-edit"></i>
                                                            Add Evaluation
                                                        </a>
                                                        <br>
                                                        <a href="edit.eval.php<?php echo '?stud_id=' . $id; ?>"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a type="button"
                                                                    href="userData/user.del.admin.php?stud_id=<?php echo $row['stud_id'] ?>"
